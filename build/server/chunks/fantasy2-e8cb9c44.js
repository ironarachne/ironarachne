...
import { C as CharacterGenerator } from './fantasy-e08cb8d7.js';
import { g as getFantasy } from './premadeconfigs-d2ecb40b.js';
import './sentry-release-injection-file-2a0756c4.js';
import { b as HeraldryGeneratorConfig, m as matchingAnyTags, c as all$4 } from './svg-7410a8cf.js';
...
function generateType$2() {
  ...
  config.chargeOptions = matchingAnyTags(["weapon", "armor", "aggressive"], all$4());
...
function generateType$1() {
  let config = new HeraldryGeneratorConfig();
  config.chargeCount = RND.item([0, 1]);
  config.chargeOptions = matchingAnyTags(["coin", "money", "trade"], all$4());
  let company = new OrganizationType(
    "trading company",
    30,
    200,
...
function generateType() {
  let config = new HeraldryGeneratorConfig();
  config.chargeCount = RND.item([0, 1]);
  config.chargeOptions = matchingAnyTags(["book", "magic", "monster"], all$4());
...
export { Title as T, generate as g };
//# sourceMappingURL=fantasy2-e8cb9c44.js.map
