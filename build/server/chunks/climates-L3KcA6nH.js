...
const TemperateClimate = {
  ...
  seasons: [
    { name: "spring", precipitationType: byName("rain"), precipitationAmount: 5 },
    { name: "summer", precipitationType: byName("rain"), precipitationAmount: 3 },
    { name: "autumn", precipitationType: byName("rain"), precipitationAmount: 3 },
    { name: "winter", precipitationType: byName("snow"), precipitationAmount: 5 }
  ]
};
...
function generate(config) {
  ...
  for (let i = 0; i < config.availableBiomes.length; i++) {
    let biome2 = config.availableBiomes[i];
    if (matchesClimate(biome2, config.climate)) {
      options.push(biome2);
    }
  }
  if (options.length === 0) {
...
function getDefaultConfig() {
  return {
    availableBiomes: all$1(),
    climate: TemperateClimate
  };
}
function matchesClimate(biome, climate) {
...
const ContinentalClimate = {
  ...
  precipitationFrequency: 5,
  seasons: [
    { name: "spring", precipitationType: byName("rain"), precipitationAmount: 6 },
    { name: "summer", precipitationType: byName("rain"), precipitationAmount: 4 },
    { name: "autumn", precipitationType: byName("rain"), precipitationAmount: 4 },
    { name: "winter", precipitationType: byName("snow"), precipitationAmount: 4 }
  ]
};
const DryClimate = {
  name: "dry",
  ...
  seasons: [
    { name: "dry", precipitationType: byName("rain"), precipitationAmount: 0 },
    { name: "wet", precipitationType: byName("rain"), precipitationAmount: 3 }
  ]
};
const PolarClimate = {
  name: "polar",
  ...
  seasons: [
    { name: "wet", precipitationType: byName("snow"), precipitationAmount: 3 },
    { name: "dry", precipitationType: byName("snow"), precipitationAmount: 0 }
  ]
};
const TropicalClimate = {
  name: "tropical",
  description: "",
  cloudCover: 8,
  windStrength: 3,
  ...
  seasons: [
    { name: "dry", precipitationType: byName("rain"), precipitationAmount: 5 },
    { name: "wet", precipitationType: byName("rain"), precipitationAmount: 9 }
  ]
};
function all() {
  return [
...
function describe(climate) {
  let description = `The climate here is ${climate.name}, with ${climate.seasons.length} seasons.`;
  return description;
}

export { all as a, getDefaultConfig as b, describe as d, generate as g };
//# sourceMappingURL=climates-L3KcA6nH.js.map
