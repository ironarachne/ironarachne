import { c as create_ssr_component, e as escape } from './ssr-93f4de0f.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  generateChopShop();
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-2qzynq_START -->${$$result.title = `<title>Chop Shop Generator | Iron Arachne</title>`, ""}<!-- HEAD_svelte-2qzynq_END -->`, ""} <section class="cyberpunk main svelte-16qhxqu"><h1 class="svelte-16qhxqu" data-svelte-h="svelte-164tsq9">Chop Shop Generator</h1> <p class="svelte-16qhxqu" data-svelte-h="svelte-1i31m3t">This is a cyberpunk chop shop generator.</p> <button class="svelte-16qhxqu" data-svelte-h="svelte-1kf9euc">Generate</button> <p class="svelte-16qhxqu">${escape(description)}</p></section>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-2b5528c0.js.map
