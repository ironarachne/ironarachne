...
class BiomeGeneratorConfig {
  availableBiomes;
  climate;
  constructor(climate) {
    this.availableBiomes = all$2();
...
class BiomeGenerator {
  ...
  generate() {
    ...
    for (let i = 0; i < this.config.availableBiomes.length; i++) {
      let biome2 = this.config.availableBiomes[i];
      ...
      if (biome2.humidity <= humidityMax && biome2.humidity >= humidityMin && biome2.temperature <= tempMax && biome2.temperature >= tempMin) {
        options.push(biome2);
      }
    }
...
class Season {
  ...
  precipitationType;
  precipitationAmount;
  constructor(name, precipitationType, precipitationAmount) {
    this.name = name;
    this.precipitationType = precipitationType;
    this.precipitationAmount = precipitationAmount;
  }
}
class ContinentalClimate {
  name;
  description;
  cloudCover;
  windStrength;
  ...
  constructor() {
    ...
    this.seasons = [
      new Season("spring", byName("rain"), 6),
      new Season("summer", byName("rain"), 4),
      new Season("autumn", byName("rain"), 4),
      new Season("winter", byName("snow"), 4)
    ];
  }
}
class DryClimate {
  ...
  constructor() {
    ...
    this.seasons = [
      new Season("dry", byName("rain"), 0),
      new Season("wet", byName("rain"), 3)
    ];
  }
}
class PolarClimate {
  ...
  constructor() {
    ...
    this.seasons = [
      new Season("wet", byName("snow"), 3),
      new Season("dry", byName("snow"), 0)
    ];
  }
}
class TemperateClimate {
  name;
  description;
  cloudCover;
  windStrength;
  ...
  constructor() {
    ...
    this.precipitationFrequency = 5;
    this.seasons = [
      new Season("spring", byName("rain"), 5),
      new Season("summer", byName("rain"), 3),
      new Season("autumn", byName("rain"), 3),
      new Season("winter", byName("snow"), 5)
    ];
  }
}
class TropicalClimate {
  name;
  description;
  cloudCover;
  windStrength;
  ...
  constructor() {
    ...
    this.seasons = [
      new Season("dry", byName("rain"), 5),
      new Season("wet", byName("rain"), 9)
    ];
  }
}
function all() {
...
export { BiomeGenerator as B, BiomeGeneratorConfig as a, describe as d, random as r };
//# sourceMappingURL=climates-023f6bb3.js.map
