...
class HeraldrySVGRenderer {
  render(device, width, height) {
    ...
    for (let i = 0; i < device.chargeGroups.length; i++) {
      chargeGroupsSVG += device.chargeGroups[i].renderSVG(shieldWidth, shieldHeight);
    }
    let svg = svgHeader;
...
export { HeraldrySVGRenderer as H };
//# sourceMappingURL=svg-18799eec.js.map
