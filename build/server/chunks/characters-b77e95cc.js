import { g as getHumanVariant$1, a as getHumanVariant, h as humanStandard$1, b as humanStandard, i as inchesToFeetExpression, c as cmToInches, k as kgToPounds, r as randomWeighted$1, d as getSizeConfig } from './size_matrix-c687e067.js';
...
const aarakocra = {
  ...
  ageCategories: getHumanVariant$1(1.2),
  baseThreatLevel: 1,
  abilities: [
    {
      name: "flight",
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.7, 0.95),
...
const aasimar = {
  ...
  ageCategories: getHumanVariant$1(1.6),
  baseThreatLevel: 1,
  abilities: [
    {
      name: "healing touch",
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.9, 0.95),
...
const bugbear = {
  ...
  ageCategories: getHumanVariant$1(0.8),
  baseThreatLevel: 2,
  abilities: [],
  commonality: 5,
  genders: [
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.1, 1.15),
...
const centaur = {
  ...
  ageCategories: getHumanVariant$1(1.85),
  baseThreatLevel: 2,
  abilities: [],
  commonality: 5,
  genders: [
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.45, 1.25),
...
const dark_elf = {
  ...
  ageCategories: getHumanVariant$1(7),
  baseThreatLevel: 1,
  abilities: [
    {
      name: "darkvision",
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.6, 0.9),
...
const deep_gnome = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.5, 0.5),
  tags: ["corruptible", "deep gnome", "gnome", "martial", "magic", "sentient"]
};
let ageCategories = getHumanVariant$1(0.8);
...
const dragonborn = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.7, 1.1),
...
const duergar = {
  ...
  ageCategories: getHumanVariant$1(3),
  baseThreatLevel: 1,
  abilities: [
    {
      name: "darkvision",
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1, 0.75),
...
const firbolg = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.9, 1.8),
...
const gnome = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.4, 0.4),
...
const goblin = {
  ...
  ageCategories: getHumanVariant$1(1.15),
  baseThreatLevel: 1,
  abilities: [
    {
      name: "darkvision",
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(0.5, 0.6),
...
const halfling = {
  ...
  ageCategories: getHumanVariant$1(1.5),
  baseThreatLevel: 1,
  abilities: [],
  commonality: 20,
  genders: [
...
const tiefling = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.2, 1),
...
const troll = {
  ...
  sizeGeneratorConfigMatrix: getHumanVariant(1.4, 1.45),
...
export { getDefaultCharacterGeneratorConfig as a, byTag as b, all$1 as c, getSkeletonVariants as d, getVampireVariants as e, getZombieVariants as f, generate as g, human as h, getTotalThreatLevel as i, withCreatureType as j, randomUniqueSet as k, byName as l, randomWeighted as m, describe as n, getHonorific as o, randomTraits as r, sentient as s, withoutTag as w };
//# sourceMappingURL=characters-b77e95cc.js.map
