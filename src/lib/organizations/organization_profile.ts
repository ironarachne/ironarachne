    ...
    [
      {
        ...
        personalityTraits: [facet('ruthless', 'ruthless in pursuit of victory'), facet('fearsome', 'fearsome in the field')],
      ...
      },
      {
        ...
        personalityTraits: [facet('methodical', 'methodical in planning'), facet('discreet', 'discreet with employers')],
        ...
        publicStanding: facet('respected', 'respected in wider mercenary markets even when locals stay wary'),
      },
      {
        id: 'reliable_riot',
        hook: "{name}, as mercenaries go, are pretty reliable, though their celebrations are infamous.",
        personalityTraits: [facet('dependable', 'dependable on a timeline'), facet('loud', 'loud after the coin lands')],
    ...
    [
      {
        ...
        personalityTraits: [facet('meticulous', 'meticulous about provenance'), facet('cautious', 'cautious with debt')],
        ...
        publicStanding: facet('traders_favor', 'favored by merchants who care about the crate more than the story'),
      },
      {
        id: 'reliable_routes',
        hook: 'The {name} has a reputation for always delivering goods to their intended destination.',
        personalityTraits: [facet('punctual', 'punctual on caravans'), facet('tight_lipped', 'tight-lipped about routes')],
        ...
        publicStanding: facet('trusted_trade', 'trusted along trade networks more than in tavern gossip'),
      },
      {
        id: 'shady',
        hook: 'The {name} appears reputable on the surface, but is rumored to be involved in underhanded dealings.',
        personalityTraits: [facet('two_faced', 'careful in public, calculating in private'), facet('shrewd', 'shrewd with tariffs and favors')],
      ...
      },
      {
        ...
        personalityTraits: [facet('intimidating', 'intimidating to smaller traders'), facet('pragmatic', 'pragmatic about paperwork')],
        ...
        publicStanding: facet('mistrusted', 'bought from when they must be, not when people want to'),
      },
      {
        id: 'variety',
        hook: 'The {name} deals in a wide variety of goods.',
        personalityTraits: [facet('diverse', 'eclectic in inventory'), facet('networked', 'connected in many markets')],
    ...
    [
      {
        ...
        personalityTraits: [facet('patient', 'patient with the loom'), facet('proud', 'proud of family patterns')],
        goal: facet('lineage', 'passing unwritten recipes down the hall'),
        weakness: facet('secrecy', 'silence that invites rumor'),
        publicStanding: facet('guild_respect', 'respected in guild markets even if travelers find them aloof'),
      },
      {
        id: 'dye_secrets',
        hook: 'Some merchants who deal with {name} never ask where the dyes really come from.',
        personalityTraits: [facet('secretive', 'secretive with dye books'), facet('fierce', 'fierce about color fastness')],
      ...
      },
      {
        ...
        personalityTraits: [facet('communal', 'communal in production'), facet('sharp', 'sharp on pricing for strangers')],
      ...
      },
      {
        ...
        personalityTraits: [facet('disciplined', 'disciplined in oral tradition'), facet('cunning', 'cunning in contracts')],
        ...
        publicStanding: facet('crafty', 'known as brilliant and slightly unsettling in equal measure'),
      },
    ],
  ],
  [
    ...
    [
      {
        ...
        personalityTraits: [facet('formal', 'formal in ceremony'), facet('uncompromising', 'uncompromising about a clean impression')],
      ...
      },
      {
        ...
        personalityTraits: [facet('material', 'insistent on physical seals'), facet('proud', 'proud of weight and ring')],
      ...
      },
      {
        ...
        personalityTraits: [facet('understated', 'understated in dress'), facet('learned', 'learned in precedent')],
      ...
      },
      {
        ...
        personalityTraits: [facet('pedagogical', 'patient with students'), facet('stern', 'stern on sloppy strokes')],
    ...
    [
      {
        ...
        personalityTraits: [facet('reclusive', 'reclusive in policy'), facet('guarded', 'guarded in correspondence')],
      ...
      },
      {
        ...
        personalityTraits: [facet('hierarchical', 'hierarchical in seating'), facet('groomed', 'groomed for pageantry')],
      ...
      },
      {
        ...
        personalityTraits: [facet('inquisitive', 'restlessly inquisitive'), facet('ruthless', 'ruthless in ethical lines')],
      ...
      },
      {
        ...
        personalityTraits: [facet('open', 'open in admissions once talent appears'), facet('loud', 'loud in debate')],
    ...
    [
      {
        ...
        personalityTraits: [facet('ceremonial', 'ceremonial in public'), facet('orderly', 'orderly in ledgers of mercy')],
        ...
        publicStanding: facet('beloved_suspected', 'beloved in market squares, analyzed in taverns'),
      },
      {
        id: 'inquisition_mercy',
        hook: '{name} is whispered to hunt heretics in the night while publicly preaching mercy.',
        personalityTraits: [facet('zealous', 'zealous in doctrine'), facet('strategic', 'strategic in silence')],
      ...
      },
      {
        ...
        personalityTraits: [facet('custodial', 'devoted to guarded objects'), facet('hierarchical', 'hierarchical in who may approach')],
      ...
      },
      {
        ...
        personalityTraits: [facet('charitable', 'charitable in street kitchens'), facet('challenging', 'challenging in sermons to the gilded')],
        ...
        publicStanding: facet('saints_and_targets', 'saints to the hungry, a problem in council chambers'),
      },
    ],
  ],
  [
    ...
    [
      {
        ...
        personalityTraits: [facet('ancient', 'grounded in old places'), facet('intolerant', 'intolerant of casual trespass')],
        ...
        publicStanding: facet('druid_repute', 'revered by woodsmen, inconvenient to lords with deeds'),
      },
      {
        id: 'rangers',
        hook: 'Rangers trust {name} with secrets; most merchants find them a hard neighbor.',
        personalityTraits: [facet('wild', 'wild in sympathy'), facet('suspicious', 'suspicious of axes and plows')],
        ...
        publicStanding: facet('polarizing', 'a fence between reverence and muttered curses in yards'),
      },
      {
        id: 'rivers_roots',
        hook: '{name} speaks for rivers and roots with equal authority.',
        personalityTraits: [facet('holistic', 'refusing to split water from loam in judgment'), facet('fierce', 'fierce when a spring is for sale')],
        goal: facet('interdependence', 'teaching a town that a river and a field are the same case'),
        weakness: facet('abstraction', 'allies who want slogans, not slow seasons of repair'),
        publicStanding: facet('prophet_edge', 'heard as prophetic in lean years, as obstruction in booms'),
      },
      {
        id: 'rites',
        hook: '{name} keeps the old rites, even when the cities forget their names.',
        personalityTraits: [facet('stubborn', 'stubborn in calendar'), facet('literate', 'literate in songs instead of text')],
    ...
    [
      {
        ...
        personalityTraits: [facet('loyal', 'loyal to a name above a code'), facet('hierarchical', 'hierarchical in every nod')],
        ...
        publicStanding: facet('respected_resented', 'respected in court as long as the house stands tall enough'),
      },
      {
        id: 'courtyard',
        hook: '{name} drills in the courtyard while poets compose ballads in their name.',
        personalityTraits: [facet('performative', 'performative in steel'), facet('proud', 'proud in pennants')],
        ...
        publicStanding: facet('gallant', 'gallant in legend, expensive to the towns that supply them'),
      },
      {
        id: 'hedge',
        hook: '{name} is a hedge against rivals who would prefer the line extinct.',
        personalityTraits: [facet('paranoid', 'sensible paranoia in treaties'), facet('sharp', 'sharp in the lists')],
        ...
        publicStanding: facet('fearsome', 'a comfort in war, a problem in any peace with fine print'),
      },
      {
        id: 'proud',
        hook: '{name} is expensive, proud, and unfailing in public.',
        personalityTraits: [facet('proud', 'proud in every receipt'), facet('punctilious', 'punctilious in appearances')],
        ...
        publicStanding: facet('admired_sized_up', 'admired in galleries, sized up in counting houses'),
      },
    ],
  ],
  [
    ...
    [
      {
        ...
        personalityTraits: [facet('networked', 'networked in alleys and kitchens'), facet('invisible', 'careful in what name they leave')],
      ...
      },
      {
        ...
        personalityTraits: [facet('cynical', 'cynical about altruism in their line'), facet('agile', 'agile in alibis')],
        ...
        publicStanding: facet('folk_hero_taint', 'hailed in songs, shunned when purses are counted'),
      },
      {
        id: 'racket',
        hook: '{name} runs protection with one hand and quiet charity with the other.',
        personalityTraits: [facet('pragmatic', 'pragmatic about which sin funds which virtue'), facet('muscular', 'muscular in collection')],
        ...
        publicStanding: facet('ambivalent', 'bought in fear, thanked in the same week by a hungry kitchen'),
      },
      {
        id: 'rumor',
        hook: '{name} is more rumor than institution, and that suits them well.',
        personalityTraits: [facet('mysterious', 'mysterious by policy'), facet('entertaining', 'entertaining in the tale')],
        ...
        publicStanding: facet('ghostly', 'a name that ends conversations when someone coughs the wrong way'),
      },
    ],
  ],
  [
    ...
    [
      {
        ...
        personalityTraits: [facet('patient', 'patient in process'), facet('ruthless', 'ruthless in leverage')],
      ...
      },
      {
        ...
        personalityTraits: [facet('polished', 'polished in public statements'), facet('cruel', 'cruel in internal reviews')],
      ...
      },
      {
        ...
        personalityTraits: [facet('ambitious', 'hungry for first mover advantage'), facet('sterile', 'sterile in empathy')],
        ...
        publicStanding: facet('prestige_risky', 'prestige with investors, a graveyard in internal memos'),
      },
      {
        id: 'labor_law',
        hook: '{name} has outbid multiple worlds for a narrow lease on local labor law.',
        personalityTraits: [facet('legalistic', 'legalistic in fine print'), facet('arrogant', 'arrogant in footprint')],
    ...
    [
      {
        ...
        personalityTraits: [facet('improvisational', 'fast with rules'), facet('muscular', 'muscular in enforcement')],
      ...
      },
      {
        ...
        personalityTraits: [facet('duplicitous', 'two faces, one keycard'), facet('savvy', 'savvy in fees')],
      ...
      },
      {
        ...
        personalityTraits: [facet('extractive', 'extractive in calm voices'), facet('bureaucratic', 'bureaucratic in oxygen')],
        ...
        publicStanding: facet('indispensable_loathed', 'loathed, paid anyway until something breaks'),
      },
      {
        id: 'referendum',
        hook: '{name} is building a world one referendum and one bribe at a time.',
        personalityTraits: [facet('political', 'political in hallways and tunnels'), facet('cunning', 'cunning in compromise')],
    ...
    [
      {
        ...
        personalityTraits: [facet('alien_leaning', 'at home with strange notation'), facet('proud', 'proud in impact factors')],
      ...
      },
      {
        ...
        personalityTraits: [facet('competitive', 'competitive in lab coats'), facet('networked', 'networked in review boards')],
        ...
        publicStanding: facet('admired_aspirations', 'beloved of grad students, feared by deans in lean years'),
      },
      {
        id: 'trust',
        hook: "{name} is funded by a trust that predates the last three local governments on this rock.",
        personalityTraits: [facet('independent', 'independent in charter'), facet('eccentric', 'eccentric in taste')],
      ...
      },
      {
        ...
        personalityTraits: [facet('secretive', 'careful in what visitors may photograph'), facet('daring', 'daring in sublevels')],
        ...
        publicStanding: facet('dreaded_curiosity', 'dreaded and visited in the same week by the reckless'),
      },
    ],
  ],
  [
    ...
    [
      {
        ...
        personalityTraits: [facet('bold', 'bold on approach vectors'), facet('polite', 'polite in bribes phrased as tips')],
        ...
        publicStanding: facet('necessary_vice', 'cursed in customs, begged when a crop rots in silos'),
      },
      {
        id: 'grain_genes',
        hook: '{name} moves grain, genes, and guilt with the same hold manifest.',
        personalityTraits: [facet('pragmatic', 'pragmatic about cargo categories'), facet('cynical', 'cynical about customs oaths')],
      ...
      },
      {
        ...
        personalityTraits: [facet('candid', 'candid about price'), facet('slippery', 'slippery about origin')],
      ...
      },
      {
        ...
        personalityTraits: [facet('clannish', 'clannish on the deck'), facet('ruthless', 'ruthless when the heat lands')],
    ...
    [
      {
        ...
        personalityTraits: [facet('professional', 'professional in contract text'), facet('terse', 'terse in combat after')],
        ...
        publicStanding: facet('market_reliable', 'known in merc markets, absent on recruitment posters'),
      },
      {
        id: 'iff',
        hook: '{name} has no flag but their IFF tags say enough.',
        personalityTraits: [facet('cryptic', 'cryptic in branding'), facet('lethal', 'lethal when the tag is questioned')],
      ...
      },
      {
        ...
        personalityTraits: [facet('adaptable', 'adaptable in allegiance'), facet('loyal', 'loyal to coin first')],
        ...
        publicStanding: facet('pragmatic', 'respected by logistics officers, studied by historians'),
      },
      {
        id: 'licensed',
        hook: '{name} is licensed on six worlds and wanted on a seventh.',
        personalityTraits: [facet('legalistic', 'clever with papers'), facet('bold', 'bold where local law ends')],
        goal: facet('jurisdiction_arb', 'playing jurisdictions against one another for room to work'),
    ...
    [
      {
        ...
        personalityTraits: [facet('drilled', 'relentlessly drilled'), facet('weary', 'weary in a good way')],
        ...
        publicStanding: facet('professional', 'trusted in fleet briefings, mocked in bars that do not fly'),
      },
      {
        id: 'kill_marks',
        hook: '{name} paints kill marks where chaplains cannot see from the pews.',
        personalityTraits: [facet('fatalistic', 'fatalistic about vacuum'), facet('proud', 'proud in tally')],
      ...
      },
      {
        ...
        personalityTraits: [facet('methodical', 'methodical in maintenance'), facet('thrifty', 'thrifty with spall')],
...
const DEFAULT_ARCHETYPES: readonly OrgArchetype[] = [
  {
    ...
    personalityTraits: [facet('determined', 'determined in pursuit of its aims'), facet('adaptive', 'willing to shift tactics when the ground moves')],
    goal: facet('relevance', 'staying necessary to the people who sign the checks'),
    weakness: facet('overreach', 'occasionally biting off more than its chain of command can swallow'),
...
const PRESET_NARRATIVES: Readonly<Record<OrganizationWorldContextPreset, OrganizationEnvironmentNarrative>> = {
  desert_route: {
    id: 'desert_route',
...
function shouldSkipEnvironmentForSf(genre: OrganizationGenre, _kindId: string, environment: Environment): boolean {
...
function environmentToNarrative(
  ...
  if (genre === 'fantasy') {
    ...
    if (n === 'tropical savanna' || n === 'tropical seasonal forest' || n === 'tropical rainforest') {
      return {
        id: 'biome_tropical',
    ...
    if (n === 'mediterranean woodland' || n === 'temperate grassland' || n === 'flooded grassland') {
      return {
        id: 'biome_open_ground',
        shortLabel: `open ground and seasonal grass fires that redraw roads every few years`,
      };
    }
    if (n === 'temperate deciduous forest' || n === 'temperate rainforest' || n === 'boreal forest') {
      return {
        id: 'biome_forest',
...
export function buildOrganizationProfile(
  ...
  kindId: string,
  name: string,
  options: { genre: OrganizationGenre; worldContext?: OrganizationWorldContext; environment?: Environment },
): OrganizationProfile {
