...
export function horde(rng: RNG.RNG): TreasureTable[] {
  return [
    new TreasureTable([
      new TreasureTableEntry(30, new CoinGenerator('', '', '', '12d6x1000', '8d6x1000', rng)),
    ]),
    new TreasureTable([
      ...
      new TreasureTableEntry(30, new GemGenerator(95000, 100000, Dice.roll('3d6', rng), rng)),
      new TreasureTableEntry(8, new GemGenerator(495000, 500000, Dice.roll('1d8', rng), rng)),
      new TreasureTableEntry(
        10,
    ...
    new TreasureTable([
      new TreasureTableEntry(5, new MagicItemGenerator(100000, 300000, Dice.roll('1d6', rng), rng)),
    ]),
  ];
}
...
export function individual(rng: RNG.RNG): TreasureTable[] {
  return [
    new TreasureTable([
      new TreasureTableEntry(15, new CoinGenerator('', '', '2d6x1000', '8d6x100', '', rng)),
      new TreasureTableEntry(40, new CoinGenerator('', '', '', '1d6x1000', '1d6x100', rng)),
      new TreasureTableEntry(45, new CoinGenerator('', '', '', '1d6x1000', '2d6x100', rng)),
    ]),
  ];
}
