...
export const artObjectTypes: ArtObjectType[] = [
  { name: "bell", baseValue: 50, baseWeight: 0.5, densityCategory: 'dense', materialCategory: ['metal', 'ceramic'] },
  { name: "belt", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['fabric', 'metal'] },
  { name: "book", baseValue: 300, baseWeight: 2, densityCategory: 'standard', materialCategory: ['paper'] },
  { name: "boots", baseValue: 100, baseWeight: 2, densityCategory: 'standard', materialCategory: ['fabric'] },
  { name: "bottle", baseValue: 50, baseWeight: 0.5, densityCategory: 'standard', materialCategory: ['glass', 'ceramic'] },
  { name: "bowl", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'ceramic', 'wood', 'glass', 'stone'] },
  { name: "box", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['wood', 'metal', 'stone', 'organic'] },
  { name: "bracelet", baseValue: 200, baseWeight: 0.2, densityCategory: 'dense', materialCategory: ['metal', 'organic'] },
  { name: "brazier", baseValue: 100, baseWeight: 5, densityCategory: 'bulky', materialCategory: ['metal'] },
  { name: "brooch", baseValue: 300, baseWeight: 0.1, densityCategory: 'dense', materialCategory: ['metal', 'organic'] },
  { name: "cameo", baseValue: 500, baseWeight: 0.1, densityCategory: 'dense', materialCategory: ['stone', 'organic'] },
  { name: "candelabra", baseValue: 150, baseWeight: 2, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "candlestick", baseValue: 50, baseWeight: 0.5, densityCategory: 'standard', materialCategory: ['metal', 'wood', 'ceramic'] },
  { name: "casket", baseValue: 300, baseWeight: 5, densityCategory: 'standard', materialCategory: ['wood', 'metal', 'stone'] },
  { name: "cauldron", baseValue: 50, baseWeight: 5, densityCategory: 'bulky', materialCategory: ['metal'] },
  { name: "chalice", baseValue: 250, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'glass', 'ceramic', 'stone', 'wood'] },
  { name: "chess set", baseValue: 500, baseWeight: 2, densityCategory: 'standard', materialCategory: ['stone', 'wood', 'organic', 'glass'] },
  { name: "chest", baseValue: 500, baseWeight: 10, densityCategory: 'bulky', materialCategory: ['wood', 'metal'] },
  { name: "chime", baseValue: 50, baseWeight: 0.5, densityCategory: 'dense', materialCategory: ['metal', 'organic', 'glass'] },
  { name: "cloak", baseValue: 150, baseWeight: 3, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "comb", baseValue: 50, baseWeight: 0.1, densityCategory: 'standard', materialCategory: ['organic', 'metal', 'wood'] },
  { name: "crown", baseValue: 5000, baseWeight: 2, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "decanter", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['glass'] },
  { name: "dice set", baseValue: 50, baseWeight: 0.1, densityCategory: 'dense', materialCategory: ['organic', 'stone', 'wood', 'metal'] },
  { name: "drum", baseValue: 100, baseWeight: 5, densityCategory: 'bulky', materialCategory: ['wood'] },
  { name: "ewer", baseValue: 150, baseWeight: 2, densityCategory: 'standard', materialCategory: ['metal', 'ceramic', 'glass'] },
  { name: "figurine", baseValue: 50, baseWeight: 1, densityCategory: 'dense', materialCategory: ['stone', 'metal', 'wood', 'organic', 'ceramic', 'glass'] },
  { name: "flagon", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'ceramic'] },
  { name: "flute", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['wood', 'metal', 'organic'] },
  { name: "gloves", baseValue: 100, baseWeight: 0.5, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "goblet", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'glass', 'ceramic', 'stone', 'wood'] },
  { name: "harp", baseValue: 500, baseWeight: 10, densityCategory: 'bulky', materialCategory: ['wood'] },
  { name: "hat", baseValue: 50, baseWeight: 0.5, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "helm", baseValue: 300, baseWeight: 3, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "horn", baseValue: 100, baseWeight: 1, densityCategory: 'standard', materialCategory: ['organic', 'metal'] },
  { name: "hourglass", baseValue: 200, baseWeight: 1, densityCategory: 'standard', materialCategory: ['glass'] },
  { name: "idol", baseValue: 1000, baseWeight: 5, densityCategory: 'dense', materialCategory: ['stone', 'metal', 'wood', 'organic'] },
  { name: "inkwell", baseValue: 50, baseWeight: 0.5, densityCategory: 'standard', materialCategory: ['glass', 'ceramic', 'metal'] },
  { name: "jar", baseValue: 20, baseWeight: 0.5, densityCategory: 'standard', materialCategory: ['ceramic', 'glass'] },
  { name: "kettle", baseValue: 30, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "lamp", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'ceramic'] },
  { name: "lantern", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "letter opener", baseValue: 50, baseWeight: 0.2, densityCategory: 'standard', materialCategory: ['metal', 'organic', 'wood'] },
  { name: "lute", baseValue: 200, baseWeight: 5, densityCategory: 'bulky', materialCategory: ['wood'] },
  { name: "magnifying glass", baseValue: 100, baseWeight: 0.5, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "mask", baseValue: 150, baseWeight: 1, densityCategory: 'airy', materialCategory: ['metal', 'wood', 'organic', 'fabric', 'ceramic'] },
  { name: "mirror", baseValue: 200, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "mosaic", baseValue: 2500, baseWeight: 30, densityCategory: 'standard', materialCategory: ['stone', 'ceramic', 'glass'] },
  { name: "necklace", baseValue: 500, baseWeight: 0.2, densityCategory: 'dense', materialCategory: ['metal', 'organic'] },
  { name: "painting", baseValue: 2000, baseWeight: 5, densityCategory: 'bulky', materialCategory: ['mixed'] },
  { name: "pan", baseValue: 20, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "pendant", baseValue: 200, baseWeight: 0.1, densityCategory: 'dense', materialCategory: ['metal', 'stone', 'organic'] },
  { name: "platter", baseValue: 100, baseWeight: 3, densityCategory: 'standard', materialCategory: ['metal', 'ceramic', 'wood'] },
  { name: "playing cards", baseValue: 50, baseWeight: 0.2, densityCategory: 'dense', materialCategory: ['paper', 'organic'] },
  { name: "pot", baseValue: 20, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'ceramic'] },
  { name: "quill", baseValue: 20, baseWeight: 0.01, densityCategory: 'airy', materialCategory: ['organic'] },
  { name: "ring", baseValue: 150, baseWeight: 0.05, densityCategory: 'dense', materialCategory: ['metal', 'organic'] },
  { name: "robe", baseValue: 200, baseWeight: 3, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "scarf", baseValue: 50, baseWeight: 0.2, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "scepter", baseValue: 2000, baseWeight: 3, densityCategory: 'dense', materialCategory: ['metal', 'wood', 'organic'] },
  { name: "scroll", baseValue: 100, baseWeight: 0.5, densityCategory: 'airy', materialCategory: ['paper'] },
  { name: "sculpture", baseValue: 3000, baseWeight: 20, densityCategory: 'standard', materialCategory: ['stone', 'metal', 'wood', 'ceramic'] },
  { name: "spyglass", baseValue: 1000, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "statue", baseValue: 4000, baseWeight: 150, densityCategory: 'dense', materialCategory: ['stone', 'metal'] },
  { name: "statuette", baseValue: 100, baseWeight: 2, densityCategory: 'dense', materialCategory: ['stone', 'metal', 'wood', 'organic', 'ceramic', 'glass'] },
  { name: "stein", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['ceramic', 'metal'] },
  { name: "tankard", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal', 'wood', 'ceramic'] },
  { name: "tapestry", baseValue: 1500, baseWeight: 10, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "torch sconce", baseValue: 50, baseWeight: 1, densityCategory: 'standard', materialCategory: ['metal'] },
  { name: "urn", baseValue: 200, baseWeight: 5, densityCategory: 'standard', materialCategory: ['ceramic', 'metal', 'stone'] },
  { name: "vase", baseValue: 100, baseWeight: 2, densityCategory: 'standard', materialCategory: ['ceramic', 'glass', 'metal', 'stone'] },
  { name: "vestments", baseValue: 500, baseWeight: 3, densityCategory: 'airy', materialCategory: ['fabric'] },
  { name: "whistle", baseValue: 20, baseWeight: 0.1, densityCategory: 'dense', materialCategory: ['metal', 'wood', 'organic', 'ceramic'] },
];
 ...
 */
export function generateRandomArtObject(seed: string, config: ArtObjectGeneratorConfig = getDefaultArtObjectGeneratorConfig()): ArtObject {
 ...
 */
export function getRandomArtObjectsForValue(seed: string, totalValue: number, config: ArtObjectGeneratorConfig = getDefaultArtObjectGeneratorConfig()): ArtObject[] {
  const rng = new RNG(seed);
  const selectedArtObjects: ArtObject[] = [];
  let remainingValue = totalValue;
