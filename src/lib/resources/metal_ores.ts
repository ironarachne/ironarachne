...
export function getAllMetalOres(): Resource[] {
  return [
    ...
    },
    {
      name: "copper ore",
      description:
        "A ductile metal with high thermal and electrical conductivity.",
      major_type: "metal",
    ...
    },
    {
      name: "aluminum ore",
      description:
        "A lightweight, corrosion-resistant metal used in various applications.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "platinum ore",
      description:
        "A rare, precious metal known for its resistance to corrosion.",
      major_type: "metal",
      minor_type: "noble",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "titanium ore",
      description:
        "A strong, lightweight metal known for its corrosion resistance.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "tungsten ore",
      description:
        "A dense metal with the highest melting point of all elements.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "molybdenum ore",
      description:
        "A strong metal with a high melting point, used in steel alloys.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "tantalum ore",
      description:
        "A rare, corrosion-resistant metal used in electronics and medical devices.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
    ...
    },
    {
      name: "hafnium ore",
      description:
        "A dense, corrosion-resistant metal used in nuclear reactors and electronics.",
      major_type: "metal",
      minor_type: "non-ferrous",
      is_refineable: true,
      properties: [
