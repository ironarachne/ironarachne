...
import {
  ...
  getSolarTemperature, getPlanetTemperature,
...
describe('Albedo Calculation', () => {
  it('should calculate albedo from temperature correctly', () => {
    ...
    expect(getAlbedoFromTemperature(temperature)).toBeCloseTo(expectedAlbedo, 5);
  });
...
describe('Gravity Calculation', () => {
  it('should calculate gravity from mass and radius correctly', () => {
    ...
    expect(getGravityFromMassAndRadius(mass, radius)).toBeCloseTo(expectedGravity, 5);
  });
});
...
describe('Solar Temperature Calculation', () => {
  it('should calculate solar temperature correctly', () => {
    ...
    const expectedTemp = (luminosity * 4 * Math.PI * radius ** 2) ** 0.25 / stefanBoltzmannConstant;
...
describe('Planet Temperature Calculation', () => {
  it('should calculate an average Earth temperature based on Earth properties', () => {
    ...
    expect(getPlanetTemperature(earth_atmosphere_density, earth_orbital_distance, sun_temperature)).toBeCloseTo(expected_temperature, -1);
  });
  ...
  it('should calculate an average Venus temperature based on Venus properties', () => {
    ...
    expect(getPlanetTemperature(venus_atmosphere_density, venus_orbital_distance, sun_temperature)).toBeCloseTo(expected_temperature, -1);
  });
  ...
  it('should calculate an average Mars temperature based on Mars properties', () => {
    ...
    expect(getPlanetTemperature(mars_atmosphere_density, mars_orbital_distance, sun_temperature)).toBeCloseTo(expected_temperature, -1);
  });
  ...
  it('should calculate a colder temperature for a planet with a higher orbital distance', () => {
    ...
    expect(getPlanetTemperature(atmosphere_density, orbital_distance, star_temperature)).toBeCloseTo(expected_temperature, -1);
  });
  ...
  it('should calculate a hotter temperature for a planet with a lower orbital distance', () => {
    ...
    const star_temperature = 5772; // Sun's temperature
    const expected_temperature = 318.5; // the average temperature of a planet at 0.5 AU, in Kelvin
