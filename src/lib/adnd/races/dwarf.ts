...
export default new ADNDRace(
  ...
  function (character: ADNDCharacter): ADNDCharacter {
    ...
    character.abilities.push(
      "Within 10', detect grade or slope in passage with 1-5 on 1d6",
    );
    character.abilities.push(
      "Within 10', detect new tunnel/passage construction with 1-5 on 1d6",
    );
    character.abilities.push(
      "Within 10', detect sliding/shifting walls or rooms with 1-4 on 1d6",
    );
    character.abilities.push(
      "Within 10', detect stonework traps, pits, and deadfalls with 1-3 on 1d6",
    );
    character.abilities.push(
      "Within 10', determine approximate depth underground with 1-3 on 1d6",
    );
    return character;
  },
  8,
