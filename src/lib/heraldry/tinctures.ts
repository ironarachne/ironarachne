...
export function all(): Tincture[] {
  ...
  return [
    ...
    },
    {
      ...
      hexColor: "#e7731b",
      pattern:
        `<pattern id="tenné" x="0" y="0" width="1" height="1" patternUnits="userSpaceOnUse"><rect x="0" y="0" width="1" height="1" fill="#e7731b"/></pattern>`,
      type: "stain",
      category: "dark",
      commonality: 2,
    },
    {
      ...
      hexColor: "#7c0000",
      pattern:
        `<pattern id="sanguine" x="0" y="0" width="1" height="1" patternUnits="userSpaceOnUse"><rect x="0" y="0" width="1" height="1" fill="#7c0000"/></pattern>`,
      type: "stain",
      category: "dark",
      commonality: 2,
    },
