...
/**
 * The table of Velgarth gifts a character may be born with.
 *
 * Shared and read-only. `generate` narrows the list it works from with `filter`, which builds a new
 * array rather than removing rows from this one.
 */
export const GIFT_POSSIBILITIES: GiftPossibility[] = [
  {
    name: 'Bardic',
    description:
