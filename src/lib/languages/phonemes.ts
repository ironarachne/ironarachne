...
export function all(): Phoneme[] {
  return [
    ...
    new Phoneme(
      "c",
      ["c", "k"],
      ["consonant", "palatal", "plosive", "voiceless"],
      1,
    ),
    new Phoneme(
      "ch",
    ...
    new Phoneme(
      "d",
      ["d"],
      ["alveolar", "consonant", "dental", "plosive", "voiced"],
      1,
    ),
    new Phoneme(
      "dʒ",
      ["j"],
      ["affricate", "consonant", "postalveolar", "voiced"],
      1,
    ),
    new Phoneme(
      "tʃ",
      ["ch"],
      ["affricate", "consonant", "postalveolar", "voiceless"],
      1,
    ), // e.g. beach
    new Phoneme(
      "f",
      ["f"],
      ["consonant", "voiceless", "fricative", "labiodental"],
      1,
    ),
    ...
    new Phoneme(
      "h",
      ["h"],
      ["consonant", "voiceless", "fricative", "glottal", "transition"],
      1,
    ),
    ...
    new Phoneme(
      "m",
      ["m"],
      ["bilabial", "consonant", "nasal", "occlusive", "voiced"],
      1,
    ),
    new Phoneme(
      "n",
      ["n"],
      ["alveolar", "consonant", "dental", "nasal", "occlusive", "voiced"],
      1,
    ),
    ...
    new Phoneme(
      "s",
      ["s", "c"],
      ["consonant", "coronal", "fricative", "voiceless"],
      1,
    ),
    ...
    new Phoneme(
      "ʒ",
      ["si", "zh"],
      ["consonant", "fricative", "palato-alveolar", "sibilant"],
      1,
    ),
    ...
    new Phoneme(
      "z",
      ["z", "x"],
      ["aveolar", "consonant", "fricative", "voiced"],
      1,
    ),
...
export function byClassification(
  classification: string,
  phonemes: Phoneme[],
): Phoneme[] {
  return phonemes.filter((phoneme) =>
    phoneme.classifiers.includes(classification),
  );
}
