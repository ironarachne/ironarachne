    ...
    return [
        {
            ...
            temperatureMax: 30,
            temperatureMin: 10,
            faunaTypes: ["deer", "rabbit"],
            faunaDensity: 0.5,
            vegetationTypes: ["oak", "maple"],
        ...
        },
        {
            ...
            temperatureMax: 25,
            temperatureMin: 0,
            faunaTypes: ["bear", "wolf"],
            faunaDensity: 0.3,
            vegetationTypes: ["pine", "fir"],
        ...
        },
        {
            ...
            temperatureMax: 40,
            temperatureMin: 20,
            faunaTypes: ["camel", "scorpion"],
            faunaDensity: 0.2,
            vegetationTypes: ["cactus", "acacia"],
        ...
        },
        {
            ...
            temperatureMax: 30,
            temperatureMin: 15,
            faunaTypes: ["buffalo", "prairie dog"],
            faunaDensity: 0.4,
            vegetationTypes: ["grass", "wildflowers"],
        ...
        },
        {
            ...
            temperatureMax: 10,
            temperatureMin: -20,
            faunaTypes: ["polar bear", "arctic fox"],
            faunaDensity: 0.2,
