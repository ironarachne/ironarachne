...
function allAssets() {
  return [
    createAssetTemplate(
      'Attire',
      [
        createAssetType('Rugged', 'Crude, patched, aged and worn.'),
        createAssetType('Simple', 'Utilitarian, favors function over looks.'),
        createAssetType('Cultural', 'Incorporates popular styles/elements of a culture.'),
        createAssetType('Formal', 'Well cut and stylish.'),
        createAssetType(
          'Uniform',
      ...
      [],
      [
        createUpgrade('Armored', '+2 Armor.'),
        createUpgrade('Carapace', 'Clumsy, +3 Armor.'),
        createUpgrade('Comms', 'Can receive and broadcast signals over great distances.'),
        createUpgrade(
          'Connected',
        ...
        createUpgrade('Meshweave', '+1 Armor that looks like normal fabric.'),
        createUpgrade(
          'Rig',
          'Choose a Kit: That Kit is integrated in the suit. Can still carry a second Kit.',
        ),
        createUpgrade('Tough', 'Protects from elements, hard to damage, easy to repair.'),
        createUpgrade('Sealed', 'Airtight suit with helmet and oxygen tank.'),
        createUpgrade(
          'Sensor',
        ...
        createUpgrade('Visor', 'Choose a type of information. The visor detects that subject.'),
      ],
    ),
    createAssetTemplate(
      'Crew',
      ...
      [
        ...
        createUpgrade('Artillery', 'Able to bombard with artillery, turrets or starship weaponry.'),
        createUpgrade(
          'Athletic',
        ...
        createUpgrade('Rugged', 'Can work in harsh climates for extended periods of time.'),
        createUpgrade('Stealthy', 'Able to sneak into (or out of) places, and pass unnoticed.'),
        createUpgrade(
          'Teamsters',
          'Able to quickly load, unload, assemble and pack away heavy objects and cargo.',
        ),
        createUpgrade('Wreckers', 'Able to destroy terrain and structures.'),
      ],
    ),
    createAssetTemplate(
      'Explosive',
      [
        createAssetType('Grenade', 'One-handed thrown explosive. Optimal Range: Close'),
        createAssetType('Charge', 'Two-handed placed explosive. Optimal Range: Melee'),
      ],
      [],
      [
        createUpgrade('Breaching', 'Breaches reinforced buildings and starships. Charge only.'),
        createUpgrade(
          'Chemical',
        ...
        createUpgrade('Concealed', "Inconspicuous, easily hidden, doesn't show on scanners."),
        createUpgrade(
          'Concussive',
        ...
        createUpgrade('Focused', 'Directed high explosive force, little collateral damage.'),
        createUpgrade('Haywire', 'Disrupts electronic systems, scanners and advanced weaponry.'),
        createUpgrade('High Yield', 'Massive area of effect, city block or more. Charge only.'),
        createUpgrade('Kinetic', 'Heavy kinetic force that breaks bones and knocks people over.'),
        createUpgrade('Plasma', 'Creates a nova of incandescent energy that vaporizes matter.'),
        createUpgrade('Shock', 'Electrocutes, causes malfunctions in electronics and robots.'),
        createUpgrade(
          'Shrapnel',
          'Causes amputation, bleeding and disfigurement in a wide radius.',
        ),
        createUpgrade('Sticky', 'Attaches itself to any surface, difficult to remove.'),
        createUpgrade('Stun', 'Non-lethal. Stuns, snares or renders unconscious.'),
        createUpgrade('Stylish', 'The explosion looks impressive, distinctive and unique.'),
      ],
    ),
    createAssetTemplate(
      'Firearm',
      [
        createAssetType('Pistol', 'One handed ranged weapon, Optimal Ranges: Adjacent, Close.'),
        createAssetType('Rifle', 'Two handed ranged weapon, Optimal Ranges: Close, Far.'),
      ],
      [],
      [
        createUpgrade(
        ...
        createUpgrade('Burst', 'Instead of a single shot, sprays shots in a wide cone.'),
        createUpgrade('Concealed', "Inconspicuous, easily hidden, doesn't show on scanners."),
        createUpgrade(
          'Chemical',
          'Creates lasting chemical reaction. Ex: fire, corrosion, frost, smoke, etc.',
        ),
        createUpgrade('Destructive', 'Causes property damage, damages machinery and vehicles.'),
        createUpgrade(
          'Explosive',
          'Loud. Causes messy wounds, property damage near the point of impact.',
        ),
        createUpgrade('Impact', 'Heavy kinetic force that breaks bones and knocks people over.'),
        createUpgrade('Keyed', 'Can only be fired by you unless you unlock it.'),
        createUpgrade('Laser', 'Projects focused beams of energy that can cut or melt materials.'),
        createUpgrade('Launcher', 'Lobbed, arcing projectile with a modest area of effect.'),
        createUpgrade('Mounted', 'Mounted to a forearm or shoulder rig, keeps hands free.'),
        createUpgrade('Penetrating', 'Ignores Armor.'),
        createUpgrade('Plasma', 'Fires bright bolts of supercharged, burning energy.'),
        createUpgrade('Rapid Fire', 'Unleashes suppressing fire at multiple targets.'),
        createUpgrade('Scope', 'Can fire at distant objects. Optimal Ranges: Far, Distant.'),
        createUpgrade('Shock', 'Electrocutes, causes malfunctions in electronics and robots.'),
        createUpgrade(
          'Shrapnel',
          'Causes amputation, bleeding and disfigurement in a small radius.',
        ),
        createUpgrade('Silenced', 'Suppressed muzzle flash and practically silent shot.'),
        createUpgrade('Stabilized', 'No recoil, can be used in micro-gravity environments.'),
        createUpgrade('Stun', 'Non-lethal. Stuns, snares or renders unconscious.'),
        createUpgrade('Stylish', 'Looks impressive, distinctive and unique.'),
      ],
    ),
    createAssetTemplate(
      'Flyer',
      ...
      [],
      [
        createUpgrade('Agile', 'Quick, maneuverable, able to perform stunts.'),
        createUpgrade('Armored', '+2 Armor.'),
        createUpgrade(
          'Armed',
        ...
        createUpgrade('Sensors', 'The vehicle gathers various types of information.'),
        createUpgrade(
          'Shielded',
        ...
        createUpgrade('Transport', 'Can carry a dozen people or a cargo container. Shuttle only.'),
        createUpgrade(
          'Turret',
          'A heavy weapon (purchased separately) on a swivel mount, fired by a passenger.',
        ),
        createUpgrade('Workspace', 'Choose a Kit to be integrated into the vehicle.'),
      ],
    ),
    createAssetTemplate(
      'Heavy Weapon',
      [],
      [
        createUpgrade('Heavy Weapon', 'Two-handed ranged weapon. Optimal Ranges: Far, Distant.'),
        createUpgrade('Destructive', 'Causes property damage, damages machinery and vehicles.'),
        createUpgrade('Clumsy', 'Heavy and awkward, forces Face Adversity on physical activity.'),
      ],
      [
        createUpgrade('Breaching', 'Damages starships and reinforced structures.'),
        createUpgrade(
          'Chemical',
          'Creates lasting chemical reaction. Ex: fire, corrosion, frost, smoke, etc.',
        ),
        ...
        createUpgrade('Detonation', 'Explodes in a large blast radius.'),
        createUpgrade('Impact', 'Heavy kinetic force that breaks bones and knocks people over.'),
        createUpgrade('Keyed', 'Can only be fired by you unless you unlock it.'),
        createUpgrade('Laser', 'Projects focused beams of energy that can cut or melt materials.'),
        createUpgrade('Penetrating', 'Ignores Armor.'),
        createUpgrade('Plasma', 'Fires bright bolts of supercharged, burning energy.'),
        createUpgrade('Seeking', 'Projectile arcs towards a moving target.'),
        createUpgrade('Shock', 'Electrocutes, causes malfunctions in electronics and robots.'),
        createUpgrade(
          'Shrapnel',
          'Causes amputation, bleeding and disfigurement in a wide radius.',
        ...
        createUpgrade('Stun', 'Non-lethal. Stuns, snares or renders unconscious.'),
        createUpgrade('Stylish', 'Looks impressive, distinctive and unique.'),
        createUpgrade('Sustained', 'Unleashes a constant suppressing fire at multiple targets.'),
      ],
    ),
    createAssetTemplate(
      'Land Vehicle',
      ...
      [
        ...
        createUpgrade('Boosters', 'Greatly increases overland speed. Allows short jumps.'),
        createUpgrade('Controlled', 'Can be remotely activated and given directions.'),
        createUpgrade(
          'Luxury',
          'Impressive, high quality and very comfortable. Various quality-of-life features.',
        ),
        createUpgrade('Plated', '+3 Armor.'),
        createUpgrade(
          'Reinforced',
    ...
    createAssetTemplate(
      ...
      [],
      [
        createUpgrade('Melee Weapon', 'Optimal Range: Melee.'),
      ...
      [
        createUpgrade('Concealed', "Inconspicuous, easily hidden, doesn't show on scanners."),
        createUpgrade('Defensive', 'Can parry, deflect and disarm.'),
        createUpgrade('Destructive', 'Causes property damage, damages machinery and vehicles.'),
        createUpgrade('Energy', 'Glows with incandescent energy, melts, burns, cauterizes.'),
        createUpgrade(
          'Flexible',
          'Whip length capable of binding and lashing. Optimal Range: Adjacent',
        ),
        createUpgrade('Glove', 'A heavy, weaponized glove. Can still manipulate objects.'),
        createUpgrade('Hafted', 'Two handed. Long reach. Sweeping attacks. Range: Melee, Adjacent'),
        createUpgrade(
          'Heavy',
        ...
        createUpgrade('Penetrating', 'Ignores Armor.'),
        createUpgrade('Ripper', 'Loud mechanical motion rips, tears, grinds or shreds.'),
        createUpgrade('Severing', 'Chops, cuts, causes bleeding and can sever limbs.'),
        createUpgrade('Shock', 'Electrocutes, causes malfunctions in electronics and robots.'),
        createUpgrade('Stun', 'Non-lethal. Stuns, snares or renders unconscious.'),
        createUpgrade('Stylish', 'Looks impressive, distinctive and unique.'),
        createUpgrade(
  ...
  return [
    ...
    createCareer(
      ...
      [
        ...
        createSkill('Toughness', 'You can suffer two injuries of each severity, rather than one.'),
        createSkill(
          'Heavy Lifting',
