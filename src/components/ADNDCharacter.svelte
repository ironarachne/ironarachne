<script lang="ts">
  ...
  import ADNDCharacterGenerator from "../modules/adnd/adndcharactergenerator";
  import ADNDCharacterGeneratorConfig from "../modules/adnd/adndcharactergeneratorconfig";
