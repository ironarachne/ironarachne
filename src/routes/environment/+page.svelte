...
<section class="main default">
  ...
  <div class="input-group">
    ...
    <input
      ...
      bind:value={config.erosionStrength}
      id="erosionStrength"
    />
  </div>
  ...
  <div class="input-group">
    ...
    <input
      type="number"
      name="terrainVector0"
      bind:value={config.terrainVector[0]}
      id="terrainVector0"
    />
  </div>
  ...
  <div class="input-group">
    ...
    <input
      type="number"
      name="terrainVector1"
      bind:value={config.terrainVector[1]}
      id="terrainVector1"
    />
  </div>
