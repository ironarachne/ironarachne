  ...
  function generate() {
    ...
    if (organizationTypeName !== 'any') {
      genConfig.organizationTypes = [
        Organizations.getTypeByName(organizationTypeName, FantasyOrganizations.getTypes(rng)),
      ];
    } else {
...
<section class="fantasy main">
  ...
  <p>
    If you choose the Name Set "any," it will generate names according to the race of each
    character. Otherwise, the names will adhere to whichever name set you choose.
  </p>
