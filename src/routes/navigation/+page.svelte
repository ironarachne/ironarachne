...
section.navigation {
  ...
  .cyberpunk {
    ...
    a {
      ...
      border: 1px solid $ironArachneGreen;
      box-shadow: none;
      color: #d8f6b0;
  ...
  .scifi {
    ...
    a {
      ...
      background: linear-gradient(
        ...
        rgba(51, 57, 136, 1) 0%,
        rgba(41, 74, 187, 1) 50%,
        rgba(51, 57, 136, 1) 100%
      );
      box-shadow: 0 0 3px rgba(0, 180, 255, 1);
      color: white;
...
<svelte:head>
  <title>Navigation | Iron Arachne</title>
</svelte:head>
