...
export function getTraitsWithOpposingTag(traits, tag) {
  let result = []

  for (let i=0;i<traits.length;i++) {
    if (traits[i].opposingTags.includes(traits[i], tag)) {
...
export function getTraitsWithoutOpposingTag(traits, tag) {
  let result = []
...
export function getTraitsWithoutOpposingTags(traits, tags) {
  let result = []
...
export function getTraitsWithTag(traits, tag) {
  let result = []
...
export function getTraitsWithoutTag(traits, tag) {
  let result = []
...
export function getTraitsWithoutTags(traits, tags) {
  let result = []
...
export function getRandomTraits(gender, numberOfNegativeTraits, numberOfPositiveTraits) {
  let positiveTraits = []
  let negativeTraits = []
  ...
  for (let i=0;i<numberOfPositiveTraits;i++) {
    ...
    opposingTags = new Set([...opposingTags])
  }
