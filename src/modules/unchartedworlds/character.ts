...
export class UpgradeWithExtras {
  name: string;
  description: string;
  extraUpgrades: number;

  constructor(name: string, description: string, extraUpgrades: number) {
    this.name = name;
    this.description = description;
...
export class Asset {
  ...
  assetClass: number;
  type: AssetType;
  upgrades: (UpgradeWithExtras | Upgrade)[];

  constructor(name: string, description: string, assetClass: number, type: AssetType, upgrades: (UpgradeWithExtras | Upgrade)[]) {
    this.name = name;
    this.description = description;
  ...
  return [
    new AssetTemplate(
      ...
      [
        ...
        new Upgrade(
          "Meshweave",
          "+1 Armor that looks like normal fabric.",
        ),
        new Upgrade(
          "Rig",
        ...
        new Upgrade(
          "Sealed",
          "Airtight suit with helmet and oxygen tank.",
        ),
        new Upgrade(
          "Sensor",
    ...
    new AssetTemplate(
      ...
      [
        ...
        new Upgrade(
          "Wreckers",
          "Able to destroy terrain and structures.",
        ),
      ],
    ),
    new AssetTemplate(
    ...
    new AssetTemplate(
      ...
      [
        ...
        new Upgrade(
          "Stylish",
          "Looks impressive, distinctive and unique.",
        ),
      ],
    ),
    new AssetTemplate(
      ...
      [
        new Upgrade(
          "Agile",
          "Quick, maneuverable, able to perform stunts.",
        ),
        new Upgrade(
          "Armored",
          "+2 Armor.",
    ...
    new AssetTemplate(
      ...
      [
        ...
        new Upgrade(
          "Detonation",
          "Explodes in a large blast radius.",
        ),
        new Upgrade(
          "Impact",
          "Heavy kinetic force that breaks bones and knocks people over.",
        ...
        new Upgrade(
          "Seeking",
          "Projectile arcs towards a moving target.",
        ),
        new Upgrade(
          "Shock",
          "Electrocutes, causes malfunctions in electronics and robots.",
...
export class Career {
  ...
  constructor(name: string, descriptors: string[], workspaces: Workspace[], advancements: string[], skills: Skill[]) {
    this.name = name;
...
export class Origin {
  ...
  constructor(name: string, descriptors: string[], skills: Skill[]) {
    this.name = name;
    this.descriptors = descriptors;
    this.skills = skills;
  }
