...
import StarNationGeneratorConfig from './generatorconfig';
import StarNation from './starnation';
import * as RND from '../random';
import * as Words from '../words';
import random from 'random';
import StarSystemGeneratorConfig from '../starsystem/generatorconfig';
import StarSystemGenerator from '../starsystem/generator';
...
export default class StarNationGenerator {
  ...
  generate(): StarNation {
    ...
    nation.description = `${Words.title(nation.name)} is ${Words.article(nation.government.name)} ${
