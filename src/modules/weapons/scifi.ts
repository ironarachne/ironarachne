...
export function allTypes() {
  return [
    new WeaponType(
      ...
      [
        new WeaponComponent('barrel', ['an extended barrel', 'a short barrel', 'a grooved barrel']),
        new WeaponComponent('scope', ['advanced sighting', 'a long scope', 'a short scope']),
        new WeaponComponent('stock', [
          'a short stock',
          'a clever stock',
          'a comfortable stock',
          'an extended stock',
        ]),
        new WeaponComponent('trigger', [
          'a hair trigger',
          'a double trigger',
      ...
      [
        ...
        new WeaponEffect('sound', [
          'sounds like a buzzsaw',
          'has a high-pitched whine',
          'emits a rumbling sound',
        ]),
        new WeaponEffect('recoil', ['kicks hard', 'has no recoil', 'has a slight recoil']),
        new WeaponEffect('accuracy', [
          'has poor accuracy',
