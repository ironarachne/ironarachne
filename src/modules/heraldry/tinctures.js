...
export function all() {
  return colors().concat(metals()).concat(furs());
}
...
export function exclude(tincture, setOfTinctures) {
  var result = [];
...
export function randomExcluding(tincture) {
  let result = {};

  let allTinctures = all();

  let possible = exclude(tincture, allTinctures);

  result = RND.item(possible);

  return result;
}

export function randomWeighted() {
  let tinctureType = randomWeightedType();
...
export function randomWeightedExcluding(tincture) {
  let tinctureType = randomWeightedType();
...
export function randomWeightedType() {
  ...
  let tinctureType = RND.weighted(weights);

  return tinctureType.item;
}

export function randomMetal() {
  let metal = RND.item(metals());
  return metal;
}

export function randomColor() {
  let color = RND.item(colors());
  return color;
}

export function randomFur() {
  let fur = RND.item(furs());
  return fur;
}
