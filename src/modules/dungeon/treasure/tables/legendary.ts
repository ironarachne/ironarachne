...
export function horde(): TreasureTable[] {
  return [
    ...
    new TreasureTable([
      new TreasureTableEntry(20, new ArtObjectGenerator(250000, 250000, Dice.roll('1d10'))),
      ...
      new TreasureTableEntry(10, new ArtObjectGenerator(750000, 750000, Dice.roll('1d4'))),
    ]),
  ];
}
