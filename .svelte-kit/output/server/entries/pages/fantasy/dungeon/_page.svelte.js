...
import { v as valueToCoins } from "../../../../chunks/currency.js";
import * as RND from "@ironarachne/rng";
import * as Words from "@ironarachne/words";
import "seedrandom";
import { r as randomTraits, g as getSkeletonVariants, a as getVampireVariants, b as getZombieVariants, c as generate$3, d as getTotalThreatLevel, s as sentient, w as withoutTag, e as all$k, f as byName$2, h as withCreatureType, i as byTag$1, j as randomUniqueSet } from "../../../../chunks/characters.js";
import { g as getFantasy } from "../../../../chunks/premade_configs.js";
import { r as randomWeighted, g as getSizeConfig } from "../../../../chunks/size_matrix.js";
import random from "random";
import "../../../../chunks/sentry-release-injection-file.js";
import { a as all$n, g as generate$4, b as getDefaultConfig$2 } from "../../../../chunks/climates.js";
import { M as MeleeWeapon, w as withMaxQuality, a as withMinQuality, b as all$l, c as byName$1, f as forCategory, d as all$m } from "../../../../chunks/patterns.js";
...
function generateSentientMobs(speciesOptions, archetypes, amount) {
  ...
  for (let i = 0; i < amount; i++) {
    let c = generate$3(charGenConfig);
...
function getDefaultConfig$1() {
  return {
    ...
    creatureOptions: withoutTag("sentient", all$k),
    minThreatLevel: 1,
    maxThreatLevel: 4
  };
}
...
function getItemGenerator(itemName, quality) {
  ...
  itemGenConfig.pattern = byName$1(itemName);
  let minValue = 0;
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 2,
          isSentient: true,
          archetypes: [byName$2("raider captain", allArchetypes)],
        ...
        },
        {
          ...
          threatLevel: 3,
          isSentient: true,
          archetypes: [byName$2("raider", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 3,
          maxNumber: 6
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 3,
          isSentient: true,
          archetypes: [byName$2("thug", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 3,
          maxNumber: 6
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 1,
          isSentient: true,
          archetypes: [byName$2("cult acolyte", allArchetypes)],
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 2,
          isSentient: true,
          archetypes: [byName$2("cult priest", allArchetypes)],
          filter: new MobFilter([], ["cult", "corruptible"], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 5,
          isSentient: true,
          archetypes: [byName$2("cult high priest", allArchetypes)],
          filter: new MobFilter([], ["cult", "corruptible"], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 5,
          isSentient: true,
          archetypes: [byName$2("archmage", allArchetypes)],
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 2,
          isSentient: true,
          archetypes: [byName$2("mage", allArchetypes)],
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 1,
          isSentient: true,
          archetypes: [byName$2("soldier", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 2,
          maxNumber: 4
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 2,
          isSentient: true,
          archetypes: [byName$2("veteran soldier", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 2,
          maxNumber: 4
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 2,
          isSentient: true,
          archetypes: [byName$2("captain", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        },
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 3,
          isSentient: true,
          archetypes: [byName$2("general", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        },
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 5,
          isSentient: true,
          archetypes: [byName$2("lich", allArchetypes)],
          filter: new MobFilter([], [], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        }
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 5,
          isSentient: true,
          archetypes: [byName$2("necromancer", allArchetypes)],
          filter: new MobFilter([], [], "humanoid", "", ["undead"]),
          minNumber: 1,
          maxNumber: 1
        },
        {
          ...
          isSentient: true,
          archetypes: [
            byName$2("warrior", allArchetypes),
            byName$2("soldier", allArchetypes),
            byName$2("guard", allArchetypes)
          ],
      ...
      groupTemplates: [
        {
          ...
          isSentient: true,
          archetypes: [
            byName$2("shambler", allArchetypes),
            byName$2("sprinter", allArchetypes)
          ],
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 5,
          isSentient: true,
          archetypes: [byName$2("warrior", allArchetypes)],
      ...
      groupTemplates: [
        {
          ...
          threatLevel: 3,
          isSentient: true,
          archetypes: [byName$2("hunter", allArchetypes)],
          filter: new MobFilter(["martial"], [], "humanoid", "", ["undead"]),
          minNumber: 3,
          maxNumber: 6
        }
...
function getDefaultConfig() {
  let climate = RND.item(all$n());
  let biomeGenConfig = getDefaultConfig$2();
  biomeGenConfig.climate = climate;
  let biomes = [];
  for (let i = 0; i < 5; i++) {
    biomeGenConfig.climate = RND.item(all$n());
    biomes.push(generate$4(biomeGenConfig));
  }
  return {
    width: 40,
    height: 50,
