...
import { c as getHumanVariant, d as getHumanVariant$1, j as convertMatrixToSummary } from "../../../chunks/size_matrix.js";
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function calculate() {
    ...
    femaleAgeCategories = getHumanVariant(ageScale);
    maleAgeCategories = getHumanVariant(ageScale);
    femaleSizeMatrix = getHumanVariant$1(femaleWeightModifier / 100, femaleHeightModifier / 100);
    maleSizeMatrix = getHumanVariant$1(maleWeightModifier / 100, maleHeightModifier / 100);
