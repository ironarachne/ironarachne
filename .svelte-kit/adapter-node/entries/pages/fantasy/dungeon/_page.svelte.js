...
import { M as MeleeWeapon, w as withMaxQuality, a as withMinQuality, b as all$u, c as byName$2, f as forCategory, d as all$v } from "../../../../chunks/patterns.js";
...
class DungeonGeneratorConfig {
  ...
  constructor() {
    ...
    let biomes = [];
    for (let i = 0; i < 5; i++) {
      biomeGen.config.climate = random$1();
